...
- El texto de Facebook ("facebookCaption") lleva un tono más narrativo: un gancho, y una pregunta al final que invite a comentar. NO escribas la URL del cuento ni digas "en elarboldelashistorias.com/...": el enlace se añade automáticamente después, en su propia línea, así que si tú también lo escribes saldría dos veces. Puedes invitar a leerlo ("te lo dejo aquí debajo", "el enlace está justo debajo"), pero la dirección la pone el código, no tú.
- El texto de Instagram ("instagramCaption") es más corto y directo, con el gancho en la primera línea. Escribe SOLO el gancho: no digas dónde encontrar el cuento ni cómo llegar a él (nada de "búscalo como...", "toca aquí", "visita la web" ni ninguna URL). El código añade después, en su propia línea, la llamada a la acción correcta ("Enlace en la bio"), que es la única vía pulsable que existe en Instagram; si tú también lo explicas, el pie acaba diciendo dos veces lo mismo de formas distintas.
- No uses más de 8 hashtags, todos derivados de las categorías y la edad ya dadas arriba, ninguno inventado. Cada hashtag va en una sola palabra pegada, sin espacios, guiones ni signos de puntuación dentro: Facebook e Instagram cortan la etiqueta en el primer guion o espacio, así que "#Edad5-8" se publicaría como "#Edad5" y un "-8" suelto. Escríbelo como "#Edad5a8". Las tildes y la ñ sí son válidas y puedes usarlas.
